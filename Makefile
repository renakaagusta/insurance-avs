...
# check in contracts/script/output/${CHAINID}/insurance_avs_deployment_output.json
...
deploy-insurance-contracts:
						@chmod +x ./contracts/anvil/deploy-insurance.sh
						./contracts/anvil/deploy-insurance.sh
