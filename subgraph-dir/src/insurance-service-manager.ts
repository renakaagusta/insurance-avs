...
export function handleClaimResponded(event: ClaimResponded): void {
  ...
  entity.claimIndex = event.params.claimIndex
  entity.claim_pool = event.params.claim.pool
  ...
  //
  // - contract.allClaimHashes(...)
  // - contract.allClaimResponses(...)
  // - contract.avsDirectory(...)
  // - contract.factory(...)
  // - contract.getOperatorRestakedStrategies(...)
  // - contract.getRestakeableStrategies(...)
  // - contract.inisiator(...)
  // - contract.latestClaimNum(...)
  // - contract.mergeAddresses(...)
  // - contract.operatorPublicKey(...)
  // - contract.owner(...)
